...
import org.hyperskill.app.progresses.cache.TopicProgressesCacheDataSourceImpl
...
internal class ProgressesDataComponentImpl(
    appGraph: AppGraph
    ...
    companion object {
        ...
        private val topicProgressesCacheDataSource: TopicProgressesCacheDataSource by lazy {
            TopicProgressesCacheDataSourceImpl(InMemoryRepositoryCache())
        }
    ...
    override val progressesRepository: ProgressesRepository
        get() = ProgressesRepositoryImpl(
            progressesRemoteDataSource = progressesRemoteDataSource,
