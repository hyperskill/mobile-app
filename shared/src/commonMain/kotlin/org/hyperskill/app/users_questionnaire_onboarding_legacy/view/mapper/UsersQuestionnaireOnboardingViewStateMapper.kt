...
internal class UsersQuestionnaireOnboardingViewStateMapper(
    ...
    private val title = resourceProvider.getString(
        SharedResources.strings.users_questionnaire_onboarding_title_template,
    ...
    private val choices = listOf(
        when (platform.platformType) {
            PlatformType.IOS ->
                resourceProvider.getString(SharedResources.strings.users_questionnaire_onboarding_source_app_store)
            PlatformType.ANDROID ->
                resourceProvider.getString(SharedResources.strings.users_questionnaire_onboarding_source_google_play)
        },
        resourceProvider.getString(SharedResources.strings.users_questionnaire_onboarding_source_google_search),
        resourceProvider.getString(SharedResources.strings.users_questionnaire_onboarding_source_youtube),
        resourceProvider.getString(SharedResources.strings.users_questionnaire_onboarding_source_instagram),
        resourceProvider.getString(SharedResources.strings.users_questionnaire_onboarding_source_tiktok),
        resourceProvider.getString(SharedResources.strings.users_questionnaire_onboarding_source_news),
        resourceProvider.getString(SharedResources.strings.users_questionnaire_onboarding_source_friends),
        resourceProvider.getString(SharedResources.strings.users_questionnaire_onboarding_source_other)
    )
