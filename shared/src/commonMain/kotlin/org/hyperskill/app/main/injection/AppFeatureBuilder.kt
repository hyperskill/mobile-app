...
object AppFeatureBuilder {
    fun build(authInteractor: AuthInteractor, profileInteractor: ProfileInteractor, onboardingInteractor: OnboardingInteractor): Feature<State, Message, Action> {
        val appReducer = AppReducer()
        val appActionDispatcher = AppActionDispatcher(ActionDispatcherOptions(), authInteractor, profileInteractor, onboardingInteractor)
