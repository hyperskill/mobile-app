...
internal class ProjectSelectionDetailsReducer : StateReducer<State, Message, Action> {
    ...
    private fun handleInitializeMessage(state: State): ProjectSelectionDetailsReducerResult =
    ...
    private fun handleRetryContentLoadingMessage(state: State): ProjectSelectionDetailsReducerResult =
