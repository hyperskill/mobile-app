...
class PlatformStepQuizComponentImpl(
    private val step: Step,
    private val stepQuizComponent: StepQuizComponent
) : PlatformStepQuizComponent {
    override val reduxViewModelFactory: ReduxViewModelFactory
        get() = ReduxViewModelFactory(
            mapOf(
                StepQuizViewModel::class.java to {
                    StepQuizViewModel(stepQuizComponent.stepQuizFeature.wrapWithViewContainer(), step)
                }
            )
        )
}