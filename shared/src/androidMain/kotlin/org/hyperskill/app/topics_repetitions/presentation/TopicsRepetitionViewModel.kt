...
class TopicsRepetitionViewModel(
    reduxViewContainer: ReduxViewContainer<
        TopicsRepetitionsFeature.State,
        TopicsRepetitionsFeature.Message,
        TopicsRepetitionsFeature.Action.ViewAction>
) : ReduxViewModel<
    TopicsRepetitionsFeature.State,
    TopicsRepetitionsFeature.Message,
    TopicsRepetitionsFeature.Action.ViewAction>(reduxViewContainer) {
