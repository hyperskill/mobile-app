...
enum Strings {
    ...
    enum Profile {
        ...
        static let remindersTitle = sharedStrings.profile_reminders_title.localized()
        static let remindersSchedule = sharedStrings.profile_reminders_schedule.localized()
    }
