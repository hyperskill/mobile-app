...
extension StageImplementUnsupportedModalViewController {
    struct Appearance {
        ...
        let bookImageViewSizeRatio = CGSize(width: 0.63, height: 0.20)
...
final class StageImplementUnsupportedModalViewController: PanModalPresentableViewController {
    ...
    private func setupMonitorImageView() {
        let image = UIImage(named: Images.StudyPlan.IdeRequiredModal.monitor)?.withRenderingMode(.alwaysOriginal)
    ...
    private func setupTitleWithTextView() {
        ...
        titleLabel.text = Strings.StudyPlan.IdeRequiredModal.title
        ...
        textLabel.text = Strings.StudyPlan.IdeRequiredModal.text
